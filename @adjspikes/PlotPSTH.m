function [p_psth,plot_vector] = adjPSTH(obj,cluster,binsize,slide_duration)
...
stimInfo = obj.stiminfo;

%%%%%%%%% Load information from the AdjRaster and StimInfo Objects %%%%%%%%%%%%%%%%%%%%%
spiketrain = obj.data.adjSpiketrain.cluster(cluster).spikes;
