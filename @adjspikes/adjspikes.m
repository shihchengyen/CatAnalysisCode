...
frame_vector = stimInfo.data.framePoints/(stimInfo.data.catInfo.samplingrate/1000);
[data.adjSpiketrain,data.adjFramePoints,data.TossedSpikes] = AdjustFramesVector(sp,stimInfo,frame_vector);
...
number = 1;
if strcmp(sp.data.title,'PhotoDiode Signal')
    holdaxis = 1;
else
