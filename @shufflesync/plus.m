...
if(~isa(p,classname))
    ...
    elseif(isempty(q))
		...
		r.data.ShiftPSyncSpikes = concatenate(p.data.ShiftPSyncSpikes,q.data.ShiftPSyncSpikes,'Columnwise');
		...
		r.data.RasterMarkMatrices = {p.data.RasterMarkMatrices{:} q.data.RasterMarkMatrices{:}};
