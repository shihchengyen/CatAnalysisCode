...
if(~isa(p,classname))
    ...
    elseif(isempty(q))
        ...
        r.data.evals = [p.data.evals;q.data.evals];
        r.data.eframes = [p.data.eframes;q.data.eframes];
        r.data.stim_frames = [p.data.stim_frames;q.data.stim_frames];
        r.data.sta = [p.data.sta;q.data.sta];
